...
function init() {
  console.log('init grocery');
  
////////////////////////////////////////////////////////////////////

    var specialty_button = document.getElementById("specialty");
    var general_button = document.getElementById("general");

    specialty_button.addEventListener('click', function(){handleGrocFilterClick('Specialty')}, false);
    general_button.addEventListener('click', function(){handleGrocFilterClick('General')}, false);

     //callback function that handles filter click
  function handleGrocFilterClick(category){
    console.log("clicked grocery");
