...
function init() {
  console.log('init desserts');
  
////////////////////////////////////////////////////////////////////

    var ice_button = document.getElementById("ice");
    var pastry_button = document.getElementById("pastry");
    var cookies_button = document.getElementById("cookies");

    ice_button.addEventListener('click', function(){handleDessFilterClick('Ice')}, false);
    pastry_button.addEventListener('click', function(){handleDessFilterClick('Pastry')}, false);
    cookies_button.addEventListener('click', function(){handleDessFilterClick('Cookies')}, false);

     //callback function that handles filter click
  function handleDessFilterClick(category){
    console.log("clicked desserts");
