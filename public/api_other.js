...
////////////////////////////////////////////////////////////////////
    ...
    var bicycle_button = document.getElementById("bicycle");
    var pharmacy_button = document.getElementById("pharmacy");
    var gov_button = document.getElementById("gov");
    var beauty_button = document.getElementById("beauty");

    bicycle_button.addEventListener('click', function(){handleOthFilterClick('Bicycle')}, false);
    pharmacy_button.addEventListener('click', function(){handleOthFilterClick('Pharmacy')}, false);
    gov_button.addEventListener('click', function(){handleOthFilterClick('Government')}, false);
    beauty_button.addEventListener('click', function(){handleOthFilterClick('Beauty')}, false);

     //callback function that handles filter click
  function handleOthFilterClick(category){
