...
////////////////////////////////////////////////////////////////////
    //get buttons
    var american_button = document.getElementById("american");
    var asian_button = document.getElementById("asian");
    var brunch_button = document.getElementById("brunch");
    var halal_button = document.getElementById("halal");
    var italian_button = document.getElementById("italian");
    var mexican_button = document.getElementById("mexican");
    var pizza_button = document.getElementById("pizza");

    //add event listeners for each button
    american_button.addEventListener('click', function(){handleRestFilterClick('American')}, false);
    asian_button.addEventListener('click', function(){handleRestFilterClick('Asian')}, false);
    brunch_button.addEventListener('click', function(){handleRestFilterClick('Brunch')}, false);
    halal_button.addEventListener('click', function(){handleRestFilterClick('Halal')}, false);
    italian_button.addEventListener('click', function(){handleRestFilterClick('Italian')}, false);
    mexican_button.addEventListener('click', function(){handleRestFilterClick('Mexican')}, false);
    pizza_button.addEventListener('click', function(){handleRestFilterClick('Pizza')}, false);

     //callback function that handles filter click
  function handleRestFilterClick(category){
