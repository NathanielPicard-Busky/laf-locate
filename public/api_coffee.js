...
////////////////////////////////////////////////////////////////////
    ...
    var cafe_button = document.getElementById("cafe");
    var just_button = document.getElementById("just");
   

    cafe_button.addEventListener('click', function(){handleCofFilterClick('Cafe')}, false);
    just_button.addEventListener('click', function(){handleCofFilterClick('Coffee')}, false);


     //callback function that handles filter click
  function handleCofFilterClick(category){
    console.log("clicked coffee");
